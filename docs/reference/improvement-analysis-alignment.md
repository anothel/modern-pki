...
| Webhook/outbox safety needs negative tests. | HMAC signing, timestamp, receiver invalid-HMAC/replay validation, retry, and dead-letter behavior are implemented and documented. | Add timeout, redirect/egress, retry, and dead-letter replay tests. |
