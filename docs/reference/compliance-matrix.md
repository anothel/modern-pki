...
| NIST SP 1800-16 | Monitoring and response | Partial | Audit metadata, recovery runbook, incident response runbook, webhook/outbox safety runbook. | Structured logs, metrics, trace IDs, SIEM export, and audit retention policy remain roadmap items. |
