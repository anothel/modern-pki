...
| NIST SP 1800-16 | Monitoring and response | Partial | Audit metadata, structured startup logs, HTTP boundary metrics, recovery runbook, incident response runbook, webhook/outbox safety runbook. | DB/signer/core CLI metrics, trace/span propagation, SIEM export, and audit retention policy remain roadmap items. |
